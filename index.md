...
## Projects
### Risk-Sensitive / Variance-Aware RL
Algorithms and theory for variance-aware control and risk-sensitive learning using empirical variance estimation (bootstrapping, random scaling) and convergence analysis.

### Resource Allocation & Matching with RL
RL-based decision policies for dynamic matching and resource allocation, with applications in manufacturing systems and sequential decision processes.
